...
import { UserConfirmCodeForm } from '../../types';

const initialValues: UserConfirmCodeForm = {
   email: '',
};
...
export const NewCodePage = () => {
   ...
   const { mutate } = useNewCode();

   const handleRequestCode = (formData: UserConfirmCodeForm) => {
      mutate(formData);
      reset();
   };
